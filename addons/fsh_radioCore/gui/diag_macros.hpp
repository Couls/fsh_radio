 #define conred(MSG) "debug_console" callExtension (MSG + "#1000") 
 #define congreen(MSG) "debug_console" callExtension (MSG + "#0100") 
 #define conblue(MSG) "debug_console" callExtension (MSG + "#0010") 
