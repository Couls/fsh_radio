...
class CfgCommunicationMenu
{
	...
	class Bravo: Attack
	{
		...
		expression = "FSH_transport_request = TRUE;";
...
class FSH_RscButtonMenu : FSH_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
